...
export default function ArchivedHabitsPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-16 font-body">
      ...
      <main className="mx-auto max-w-2xl px-4 pt-8">
        <div className="space-y-6">
          ...
          {isLoading ? (
            <div className="flex h-64 flex-col items-center justify-center rounded-2xl border border-border bg-card p-8 shadow-sm">
              ...
              {archivedHabits.map((habit) => {
                ...
                return (
                  <SpotlightCard
                    ...
                    className="p-0 overflow-hidden rounded-2xl border-border bg-card shadow-sm"
                  >
            ...
            <div className="border-border/80 flex flex-col items-center justify-center rounded-2xl border border-dashed bg-card p-12 text-center shadow-sm">
